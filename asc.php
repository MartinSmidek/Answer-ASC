<?php # Systém An(w)er/YMCA Setkání/YMCA Familia, (c) 2008-2015 Martin Šmídek <martin@smidek.eu>
  ...
  #   $app        = kořenová podsložka aplikace ... asc
  ...
  $ezer_server= 
    $_SERVER["SERVER_NAME"]=='asc.bean'        ? 0 : (      // 0:lokální 
    $_SERVER["SERVER_NAME"]=='asc.doma'        ? 1 : (      // 1:Synology DOMA
...
//  }
  ...
  $add_options= (object) [
    ...
    'watch_access_opt' => // ... barvení v Uživatelé + select v ezer2.syst.ezer
       "{name:{8:'Salesiáni spolupracovníci'},
         abbr:{8:'A'},
         css:{8:'ezer_ms'}}",
    'web'          => "'ascczech.cz'", // web organizace - pro odmítnutí odhlášení
    'skill'        => "'d'",
    'autoskill'    => "'!d'",
    'db_test'      => 0,
    'dbg'          => "{path:['db2','asc']}"
  ...
  $title= "<span $title_style>$title_flag$app_name<sub>$ezer_version</sub> Salesiáni spolupracovníci</span>";
  $add_pars= array(
